...
- Me remettre 
	- le lien vers votre projet GitHub dans Classroom et marquer le travail comme terminé avant de quitter la classe.
- Remettre une version zipée de votre projet sur classroom et Léa.
...
## Instructions
1. Corriger l'erreur dans Canicule puis compléter le code pour répoudre à l'exigence suivante :  En cas d'épisode de canicule, chaque plante consomme le double de son besoin quotidien en eau. 
2. Compléter la méthode `Entretenir` dans la classe Plante (voir les TODO). Pour afficher la liste des TODO : Affichage puis Liste des tâches. 
3. Exécuter les tests unitaires fournis (il n'y a pas d'erreur dans les tests).
4. Corriger le code pour que tous les tests unitaires fournis s'exécutent correctement; ajouter un **court** commentaire pour expliquer chaque problème et chaque correction.
5. Compléter les tests (voir les TODO).
6. Exécuter à nouveau les tests et corriger au besoin le code selon les résultats obtenus.
7. Exécuter le programme et déboguer pour identifier et corriger les dernières erreurs. Indice : Bizarrement, une aussi grosse intempérie n'a l'air d'avoir aucun effet sur mon jardin!
